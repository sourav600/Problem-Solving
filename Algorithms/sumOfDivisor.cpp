...
int main(){
    ...
    cout<<divisorSum1(1)<<" "<<divisorSum2(1)<<nl;
    cout<<divisorSum1(2)<<" "<<divisorSum2(2)<<nl;
    cout<<divisorSum1(3)<<" "<<divisorSum2(3)<<nl;
    cout<<divisorSum1(4)<<" "<<divisorSum2(4)<<nl;
    cout<<divisorSum1(5)<<" "<<divisorSum2(5);
return 0;
}
